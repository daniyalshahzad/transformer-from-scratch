...
def train(opts: argparse.Namespace):
    if opts.tiny_preset:
        dir_path = Path("data/Hansard/Processed")
...
def build_vocab_parser(
    ...
    parser.add_argument(
        "--training-dir",
        type=Path,
        default=Path("data/Hansard/Training/"),
...
def build_data_train_dev_split_parser(
    ...
    parser.add_argument(
        "--train-prefixes",
        type=Path,
        default=Path("data/Hansard/Processed/train.txt.gz"),
        help="Where to output training data prefixes",
    )
    parser.add_argument(
        "--dev-prefixes",
        type=Path,
        default=Path("data/Hansard/Processed/dev.txt.gz"),
...
def build_training_parser(
    ...
    parser.add_argument(
        "--english-vocab",
        type=Path,
        default=Path("data/Hansard/Processed/vocab.e.gz"),
        help="English vocabulary file",
    )
    parser.add_argument(
        "--french-vocab",
        type=Path,
        default=Path("data/Hansard/Processed/vocab.f.gz"),
...
def build_testing_parser(
    ...
    parser.add_argument(
        "--testing-dir",
        type=Path,
        default=Path("data/Hansard/Testing/"),
